    ...
    <div className="min-h-screen bg-gray-50 font-[Inter]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <a href="/" className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: "#004ccd" }}>
                <span className="material-symbols-outlined text-white text-xl" style={{ fontVariationSettings: "'FILL' 1" }}>fingerprint</span>
              </div>
              <span className="text-xl font-bold" style={{ color: "#004ccd" }}>Fingerspot</span>
            </a>
          </div>
        </div>
      </header>
      ...
      <main className="pt-16 min-h-screen flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-[1000px] grid lg:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="hidden lg:flex flex-col justify-between p-10 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #004ccd, #0057ff)" }}>
          ...
          <div className="p-8 sm:p-10">
            ...
            {view === "login" && (
              <div>
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-gray-50/50" />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)}
                        ...
                        className="w-full px-4 pr-11 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-gray-50/50" />
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-0 pr-3.5 flex items-center">
                        <span className="material-symbols-outlined text-gray-400 text-xl">{showPassword ? "visibility_off" : "visibility"}</span>
                      </button>
                    </div>
                  </div>
                  <div className="flex items-center justify-end">
                    <button onClick={() => { setView("forgot"); setError(""); setMessage(""); }} className="text-sm font-medium hover:underline" style={{ color: "#004ccd" }}>
                      Lupa password?
                    </button>
                  </div>
                ...
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-sm"><span className="px-4 bg-white text-gray-400">Atau lanjutkan dengan</span></div>
                </div>
                <button onClick={handleGoogleLogin} disabled={loading}
                  className="w-full flex items-center justify-center gap-3 py-2.5 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50">
            ...
            {view === "register" && (
              <div>
                ...
                <p className="text-gray-500 text-sm mb-8">Buat akun baru untuk memulai.</p>
                <div className="space-y-5">
                  <div>
                  ...
                  <button onClick={handleRegister} disabled={loading}
                    className="w-full py-3 text-sm font-semibold text-white rounded-xl transition-all hover:opacity-90 shadow-lg disabled:opacity-50"
                    style={{ background: "#004ccd" }}>
            ...
            {view === "forgot" && (
              <div>
                ...
                <p className="text-gray-500 text-sm mb-8">Masukkan email untuk menerima link reset password.</p>
                <div className="space-y-5">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Email</label>
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
